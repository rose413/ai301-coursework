...
I am comfortable with Python and JavaScript/TypeScript and have experience with web development. I want to improve my ability to work in an existing open-source codebase, especially by making focused changes that I can understand and test within the available course time. I prefer issues with a clear scope and concrete acceptance criteria rather than large architectural changes.
